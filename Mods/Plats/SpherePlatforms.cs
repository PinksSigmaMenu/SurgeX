...
{
    internal class SpherePlatforms : MonoBehaviour
    {
        ...
        public static void CreatePlatforms()
        {
            ...
            HandlePlatformCreationAndDestruction(ref rplat, ref platformsR, GorillaLocomotion.Player.Instance.rightControllerTransform.position, GorillaLocomotion.Player.Instance.rightControllerTransform.rotation, rightGrab);
            HandlePlatformCreationAndDestruction(ref lplat, ref platformsL, GorillaLocomotion.Player.Instance.leftControllerTransform.position, GorillaLocomotion.Player.Instance.leftControllerTransform.rotation, leftGrab);

            UpdateColors();
        }

        private static void HandlePlatformCreationAndDestruction(ref GameObject platform, ref GameObject platformParent, Vector3 position, Quaternion rotation, bool isGrabbing)
        {
            if (isGrabbing)
            {
